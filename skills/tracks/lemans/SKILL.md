...
```
IF hostname == ngrt-ug-z2 (or $SSH_CONNECTION is set, or uname -n matches z2):
...
ELSE:
  ...
  - ITERATION_LOG.md:  ssh ngrt-ug-z2 "tail -30 <work-dir>/ITERATION_LOG.md"
  - Vault outbox:      ssh ngrt-ug-z2 "ls ~/geno-vault/outbox/<project>/ && cat ~/geno-vault/<project>/main.md"
  - Dashboard:         ssh ngrt-ug-z2 "cat ~/geno-vault/dashboard.md"
  - tmux sessions:     ssh ngrt-ug-z2 "tmux list-sessions"
```
